...
public class CsvFileReader implements CsvReader {
	...
	public static CsvFileReader createCsvFileReader(InputStream inputStream, boolean firstRowHeaderRow, char separator) {
	...
	public static int getRowsCount(String csvFile, boolean firstRowHeaderRow, char separator) {
		CsvFileReader reader = null;
		try {
			reader = createCsvFileReader(csvFile, firstRowHeaderRow, separator);
